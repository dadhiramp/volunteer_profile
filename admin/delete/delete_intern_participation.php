...
//prepare the sql
$sql = "DELETE FROM  tbl_participatn WHERE participatn_id = '$pageid' ";
...
if($affRows > 0){
	...
	window.location = "../includes/response.php?page=pages&sucess='.base64_encode(' Confermation ! <br />Your page has been deleted.').'";
	</script>';
}else{
	echo '<script type="text/javascript" language="javascript">
