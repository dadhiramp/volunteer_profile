...
<form name="form1" method="post" action="process_edit/process_edit_intern_participatio.php" class="bordersize">
  <fieldset>
    ...
    <table width="42%" border="0" cellpadding="0">
      ...
      <tr>
        <th colspan="2" align="left" scope="row"><textarea class="ckeditor" name="acont" id="acont" class="formcont" placeholder="Write like: Ring road cycle riding for job for youth in motherland campaign as venue manager on August 14, 2015" cols="45" rows="5"><?php echo $row['name_of_program']; ?></textarea></th>
      </tr>
      <tr>
