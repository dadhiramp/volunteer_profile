...
<body>
<form name="form1" method="post" action="process/process_add_vol_experiance.php" class="bordersize">
  <fieldset>
    ...
    <table width="42%" border="0" cellpadding="0">
      ...
      <tr>
        <th colspan="2" align="left" scope="row"><textarea class="ckeditor" name="acont" id="acont" class="formcont" placeholder="Write like: Conducted two days training on conflict management and positive thinking as the resource person on August 23, 2014." cols="45" rows="5"></textarea></th>
      </tr>
      <tr>
