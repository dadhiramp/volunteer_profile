...
<body>
<form name="form1" method="post" action="process/process_add_vol_trainings.php" class="bordersize">
  <fieldset>
    ...
    <table width="42%" border="0" cellpadding="0">
      ...
      <tr>
        <th colspan="2" align="left" scope="row"><textarea class="ckeditor" name="acont" id="acont" class="formcont" placeholder="Write like: Capacity development training on report writing organized by COCAP from August 14 -20, 2014" cols="45" rows="5"></textarea></th>
      </tr>
      <tr>
