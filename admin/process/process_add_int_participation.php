...
$sql = "INSERT INTO tbl_participatn 
			(interns_id, user_id, name_of_program, posted_date, updated_date)
 		VALUES
...
//success in deleting  the record
	...
	window.location = "../../includes/response.php?page=pages&sucess='.base64_encode('CONGRATULATIONS  <br />Your entry has been sent').'";
	</script>';
}else{
	echo '<script type="text/javascript" language="javascript">
	
	window.location = "../../includes/response.php?page=pages&error='.base64_encode('SORRY !<br /> Your entry has been not sent').'";
	</script>';
}
