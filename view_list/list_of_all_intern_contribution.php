...
$intcon=getAllcontributionforint();
...
$limit = " LIMIT $offset, $howMany ";*/
 // how many records should be displayed on a page?
        ...
        $pagination->records(count($intcon));
        ...
        $intcon = array_slice(
            $intcon,                                             //  from the original array we extract
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">CID</th>
    ...
    <tbody>
     <?php
	     foreach($intcon as $value){
			 ?>
    	<tr>
        	<td><input type="checkbox" name="" /></td>
            <td><?php echo $value['contributions_id']; ?></td>
            ...
            <td><a href="index.php?page=intcon&action=edit&pageid=<?php echo $value['contributions_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=intcon&action=delete&pageid=<?php echo $value['contributions_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
         <?php
		 }
		 ?> 
