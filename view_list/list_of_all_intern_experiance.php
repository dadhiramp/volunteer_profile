...
$limit = " LIMIT $offset, $howMany ";*/
 // how many records should be displayed on a page?
        ...
        $pagination->records(count($intexp));
        ...
        $intexp = array_slice(
            $intexp,                                             //  from the original array we extract
    ...
    <?php
    	...
    	<tr>
           ...
           <!-- <td>12/05/2010</td>
            ...
            <td><a href="index.php?page=intexp&action=edit&pageid=<?php echo $value['exp_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=intexp&action=delete&pageid=<?php echo $value['exp_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
                <?php
		 }
		 ?> 
