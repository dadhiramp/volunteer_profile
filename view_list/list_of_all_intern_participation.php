...
$intpart=getAllparticipationforint();
...
$limit = " LIMIT $offset, $howMany ";*/
 // how many records should be displayed on a page?
        ...
        $pagination->records(count($intpart));
        ...
        $intpart = array_slice(
            $intpart,                                             //  from the original array we extract
...
<body>
    ...
    <h2>List of Intern contributions</h2> 
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">PID</th>
             <th scope="col" class="rounded">IID</th>
            <th scope="col" class="rounded">Intern Name</th>
    ...
    <tbody>
     <?php
	     foreach($intpart as $value){
			 ?>
    	<tr>
        	<td><input type="checkbox" name="" /></td>
            <td><?php echo $value['participatn_id']; ?></td>
           ...
           <!-- <td>12/05/2010</td>
            ...
            <td><a href="index.php?page=intparti&action=edit&pageid=<?php echo $value['participatn_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=intparti&action=delete&pageid=<?php echo $value['participatn_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
         <?php
		 }
		 ?> 
