...
$limit = " LIMIT $offset, $howMany ";*/
 // how many records should be displayed on a page?
        ...
        $pagination->records(count($inttrai));
        ...
        $inttrai = array_slice(
            $inttrai,                                             //  from the original array we extract
...
<body>
    ...
    <h2>List of Volunteer Training</h2> 
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">TID</th>
    ...
    <tbody>
     <?php
    	...
    	<tr>
            ...
            <td><a href="index.php?page=inttrai&action=edit&pageid=<?php echo $value['training_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=inttrai&action=delete&pageid=<?php echo $value['training_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
           <?php
		 }
		 ?> 
