    ...
    <tbody>
      <?php
    	...
    	<tr>
            ...
            <td><a href="index.php?page=user&action=edit&pageid=<?php echo $value['user_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=user&action=delete&pageid=<?php echo $value['user_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
