...
$limit = " LIMIT $offset, $howMany ";*/
 // how many records should be displayed on a page?
        ...
        $pagination->records(count($volbeh));
        ...
        $volbeh = array_slice(
            $volbeh,                                             //  from the original array we extract
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">AID</th>
    ...
    <tbody>
    <?php
	     foreach($volbeh as $value){
			 ?>
    	<tr>
        	<td><input type="checkbox" name="" /></td>
            <td><?php echo $value['behav_id']; ?></td>
           ...
           <!-- <td>12/05/2010</td>
            ...
            <td><a href="index.php?page=intatt&action=edit&pageid=<?php echo $value['behav_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=intatt&action=delete&pageid=<?php echo $value['behav_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
         <?php
		 }
		 ?> 
