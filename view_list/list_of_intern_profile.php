...
$limit = " LIMIT $offset, $howMany ";*/
 // how many records should be displayed on a page?
        ...
        $pagination->records(count($intprof));
        ...
        $intprof = array_slice(
            $intprof,                                             //  from the original array we extract
...
<body>
    ...
    <h2>List of All Interns Profile</h2> 
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <?php
    	...
    	<tr>
            ...
            <td><a href="index.php?page=intpro&action=delete&pageid=<?php echo $value['interns_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
