...
<body>
    ...
    <h2>List of volunteer attitude</h2> 
    ...
    <?php
    	...
    	<tr>
           ...
           <!-- <td>12/05/2010</td>
            ...
            <td><a href="index.php?page=volatt&action=edit&pageid=<?php echo $value['behav_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=volatt&action=delete&pageid=<?php echo $value['behav_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
         <?php
		 }
		 ?> 
