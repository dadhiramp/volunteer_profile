...
require_once('../pagination/Zebra_Pagination.php');
 // how many records should be displayed on a page?
        ...
        $pagination->records(count($volcon));
        ...
        $volcon = array_slice(
            $volcon,                                             //  from the original array we extract
...
<title>Add Volunteer Contribution</title>
...
<body>
    ...
    <h2>List of volunteer contributions</h2> 
    ...
    <tbody>
     <?php
    	...
    	<tr>
            ...
            <td><a href="index.php?page=volcon&action=edit&pageid=<?php echo $value['contributions_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=volcon&action=delete&pageid=<?php echo $value['contributions_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
         <?php
		 }
		 ?>
