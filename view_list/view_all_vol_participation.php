...
require_once('../pagination/Zebra_Pagination.php');
 ...
 // how many records should be displayed on a page?
        ...
        $pagination->records(count($volpart));
        ...
        $volpart = array_slice(
            $volpart,                                             //  from the original array we extract
...
<body>
    ...
    <h2>List of volunteer participation</h2> 
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <?php
    	...
    	<tr>
            ...
            <td><a href="index.php?page=volpart&action=edit&pageid=<?php echo $value['participatn_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=volpart&action=delete&pageid=<?php echo $value['participatn_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
