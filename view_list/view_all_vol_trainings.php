...
$limit = " LIMIT $offset, $howMany ";*/
 // how many records should be displayed on a page?
        ...
        $pagination->records(count($voltrai));
        ...
        $voltrai = array_slice(
            $voltrai,                                             //  from the original array we extract
     ...
     <?php
    	...
    	<tr>
          ...
          <!--  <td>12/05/2010</td>
            ...
            <td><a href="index.php?page=voltrai&action=edit&pageid=<?php echo $value['training_id']; ?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="index.php?page=voltrai&action=delete&pageid=<?php echo $value['training_id']; ?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
